...
def banner():
    os.system('clear')
    print " "
    runntxt(GL+"              As-salamu Alaykum ^_^")
...
print GG+"╭────\033[91m[\033[96m Username Target ID\033[95m / \033[96mUsername Target\033[91m ] "
    ...
    .s-     --                      .:     -s.
     ...
     -s.     `--`                `.-`     .s-
      ...
      """
         ...
         print wd+" [#] JUm, my passwordt ini\033[97;1m:", len(nuub),'password'
